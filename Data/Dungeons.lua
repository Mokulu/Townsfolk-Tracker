TF_DUNGEONS = {
    ...
    { zone = TF_ZONE.TIRISFAL_GLADES, x = 0.853, y = 0.322, name = "Scarlet Monastery", minLevel = 21, recommendedLevel = { 26, 45 } },
...
--    { zone = TF_ZONE.SEARING_GORGE, x = 0.347, y = 0.86, name = "Blackrock Depths", minLevel = 48, recommendedLevel = { 52, 60 } },
--    { zone = TF_ZONE.SEARING_GORGE, x = 0.347, y = 0.86, name = "Lower Blackrock Spire", minLevel = 48, recommendedLevel = { 55, 60 } }, -- Lower
--    { zone = TF_ZONE.SEARING_GORGE, x = 0.347, y = 0.86, name = "Upper Blackrock Spire", minLevel = 48, recommendedLevel = { 55, 60 }, attunement = { item = 12344 } }, -- Upper
