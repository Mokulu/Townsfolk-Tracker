TF_DUNGEONS = {
    ...
    { zone = ZONE.ASHENVALE, x = 0.1415, y = 0.14, name = "Blackfathom Deeps", minLevel = 15, recommendedLevel = { 24, 32 } },
    { zone = ZONE.BLACKFATHOM_DEEPS, x = 0.4435, y = 0.3486, name = "Blackfathom Deeps", minLevel = 15, recommendedLevel = { 24, 32 }, entrance = true },
    { zone = ZONE.STORMWIND, x = 0.4028, y = 0.5521, name = "The Stockade", minLevel = 15, recommendedLevel = { 24, 32 } },
    { zone = ZONE.DUN_MOROGH, x = 0.2446, y = 0.3981, name = "Gnomeregan", minLevel = 19, recommendedLevel = { 29, 38 } },
    { zone = ZONE.THE_BARRENS, x = 0.4189, y = 0.895, name = "Razorfen Kraul", minLevel = 25, recommendedLevel = { 29, 38 } },
